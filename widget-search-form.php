...
class AvantLink_PSF_Widget extends WP_Widget {
	...
	function __construct() {
		...
		/* Create the widget. */
		parent::__construct( 'avantlink_psf_widget', __('AvantLink Product Search Form', 'framework'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		$strParams = isset($arrParsedUrl['query']) ? $arrParsedUrl['query'] : null;
		if ($strParams != '') {
			$arrParams = array();
